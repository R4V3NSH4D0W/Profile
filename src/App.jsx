...
const App = () => {
  ...
  return (
   ...
   <div className='text-center p-10'>
    ...
    <h3 className='text-2xl py-2  dark:text-white'>Devloper and designer.</h3>
    <p className=' text-md py-5 leading-8 text-gray-800 md:text-xl max-w-xl mx-auto  dark:text-white'>Freelancer providing services for programming and design content
  ...
  <section>
    ...
    <div className='lg:flex gap-10  dark:text-white'>
      <div className='text-center shadow-lg p-10 round-xl my-10'>
        ...
        <p className='text-gray-800 py-1  dark:text-white'>Illustration</p>
  ...
  <section>
    ...
    <div className=' flex flex-col gap-10 py-10 lg:flex-row lg:flex-wrap'>
      <div className=' basis-1/3 flex-1'>
        <img src="/web1.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
      <div className=' basis-1/3 flex-1'>
        <img src="/web2.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
      <div className=' basis-1/3 flex-1'>
        <img src="/web3.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
      <div className=' basis-1/3 flex-1' >
        <img src="/web4.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
      <div className=' basis-1/3 flex-1'>
        <img src="/web5.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
      <div className=' basis-1/3 flex-1'>
        <img src="/web6.png" className='rounded-lg object-cover' style={{width:"100%",height:"100%"}}/>
      </div>
